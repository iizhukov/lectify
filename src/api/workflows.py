...
def _node_to_dict(n):
    """Serialize DBExecutionNode to dict."""
    return {
        "id": str(n.id),
...
# =============================================
# EXECUTION — NEW ORCHESTRATOR PATH
# =============================================
...
async def execute_workflow(
    ...
    with db_repo.session() as s:
        ...
        # Create node execution records for all nodes in the workflow graph
...
async def get_node_logs(execution_id: str, node_id: str):
    ...
    # Find node by execution_id + node_id
    nodes = db.get_by_execution(execution_id)
    ...
    # Fall back to live container logs
